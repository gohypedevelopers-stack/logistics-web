...
const faqs = [
  ...
  { q: "What insurance options are available for high-value goods?", a: "We offer cargo insurance through our ship2sell Trust program, covering declared values up to $50,000 per shipment." },
];
...
export default function ServicesPage() {
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative min-h-[70vh] flex items-end pb-20 pt-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0d0c2b]/90 via-[#1e4b7a]/70 to-transparent"></div>
        </div>

        <div className="container mx-auto px-6 lg:px-16 relative z-10 max-w-6xl">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/20 border border-orange-400/30 text-orange-200 text-[10px] font-bold tracking-widest uppercase mb-8">
          ...
          <h1 className="text-5xl lg:text-7xl font-black text-white tracking-tight leading-[1.1] mb-6 max-w-2xl">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#fe6801] to-orange-300">Intelligence</span>
          </h1>
          <p className="text-orange-100/90 font-medium text-lg max-w-xl leading-relaxed mb-10">
          ...
          <Link href="/contact">
            <button className="h-12 px-8 bg-white text-[#1e4b7a] font-black text-sm rounded-xl hover:bg-orange-50 transition-colors shadow-lg flex items-center gap-2">
      ...
      {/* â”€â”€ CORE CAPABILITIES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-16 max-w-6xl">
          <div className="mb-14">
            <h2 className="text-3xl font-black text-[#1e4b7a] tracking-tight mb-3">Our Core Capabilities</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 hover:border-orange-200 hover:shadow-md transition-all group">
              ...
              <h3 className="text-[20px] font-black text-[#1e4b7a] mb-3 tracking-tight">Air Freight</h3>
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-5">
                  <div className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center">
                    <Anchor className="w-5 h-5 text-[#fe6801]" />
                  </div>
                  <span className="text-[9px] font-bold uppercase tracking-widest text-orange-200 bg-white/10 border border-white/10 px-2 py-1 rounded-full">FCL / LCL</span>
                </div>
                <h3 className="text-[20px] font-black text-white mb-3 tracking-tight">Ocean Freight</h3>
                <p className="text-orange-200/80 font-medium text-sm leading-relaxed mb-6">
                ...
                <button className="flex items-center gap-2 text-orange-300 font-bold text-sm hover:gap-3 transition-all">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 hover:border-orange-200 hover:shadow-md transition-all group">
              ...
              <h3 className="text-[20px] font-black text-[#1e4b7a] mb-3 tracking-tight">Warehousing</h3>
              <p className="text-slate-500 font-medium text-sm leading-relaxed mb-6">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-5">
                  ...
                  <div className="flex gap-2">
                    <span className="text-[9px] font-bold uppercase tracking-widest text-orange-100 bg-white/15 px-2 py-1 rounded-full">Taxes</span>
                    <span className="text-[9px] font-bold uppercase tracking-widest text-orange-100 bg-white/15 px-2 py-1 rounded-full">Customs Filing</span>
                  </div>
                </div>
                <h3 className="text-[20px] font-black text-white mb-3 tracking-tight">Customs Brokerage</h3>
                <p className="text-orange-50/80 font-medium text-sm leading-relaxed mb-6">
                ...
                <button className="h-10 px-6 bg-white text-orange-700 font-black text-sm rounded-xl hover:bg-orange-50 transition-colors shadow-sm flex items-center gap-2 w-max">
      ...
      {/* â”€â”€ NEXT-GEN VISIBILITY ENGINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="py-24 bg-[#FAFAFD]">
        <div className="container mx-auto px-6 lg:px-16 max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-orange-500 mb-6">
                AI Powered
              </div>
              <h2 className="text-4xl font-black text-[#1e4b7a] tracking-tight leading-tight mb-6">
                ...
                {[
                  ...
                  <div key={i} className="flex gap-4 items-start">
                    <div className="w-6 h-6 rounded-full bg-orange-100 flex items-center justify-center mt-0.5 shrink-0">
                      <Check className="w-3 h-3 text-orange-600 font-bold" />
                    </div>
                    <div>
                      <p className="font-bold text-[#1e4b7a] text-sm mb-0.5">{item.label}</p>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl overflow-hidden">
                {/* Fake mini dashboard */}
                <div className="bg-[#1e4b7a] px-5 py-3 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-400"></div>
                    <div className="w-2 h-2 rounded-full bg-yellow-400"></div>
                    <div className="w-2 h-2 rounded-full bg-green-400"></div>
                  </div>
                  <span className="text-[10px] font-bold text-orange-300 tracking-widest">Live Dashboard</span>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {['Air: 84', 'Ocean: 58', 'Docs: 24'].map((s, i) => (
                      <div key={i} className="bg-orange-50 border border-orange-100 rounded-lg p-3 text-center">
                        <p className="text-[10px] font-black text-[#1e4b7a]">{s}</p>
                      </div>
                    ))}
                  </div>
              ...
              {/* Accent glow */}
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-3/4 h-12 bg-orange-300/20 blur-2xl rounded-full"></div>
            </div>
          </div>
        </div>
      </section>

      {/* â”€â”€ GLOBAL COVERAGE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-16 max-w-6xl">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-black text-[#1e4b7a] tracking-tight mb-3">Global Coverage</h2>
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <details key={i} className="bg-white border border-slate-100 rounded-2xl p-6 group shadow-sm hover:shadow-md transition-all cursor-pointer">
                <summary className="flex items-center justify-between font-bold text-[#1e4b7a] text-[15px] list-none select-none">
                  {faq.q}
