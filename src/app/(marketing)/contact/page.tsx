    ...
    <div className="pt-32 pb-40 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-6 lg:px-12 max-w-6xl">
        <div className="max-w-3xl mb-16">
           ...
           <h1 className="text-5xl md:text-6xl font-black text-slate-900 tracking-tighter mb-6">Contact Our Operations Team</h1>
           <p className="text-lg text-slate-600 font-medium leading-relaxed">
             From volume pricing requests to active tracking support, our operations team is available 24/5.
           </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
           ...
           <div className="bg-white p-10 md:p-12 rounded-2xl shadow-sm border border-slate-200/80 flex flex-col relative z-10">
              ...
              <form className="space-y-6">
                 <div>
                    <label className="block text-[10px] font-bold tracking-widest text-slate-500 uppercase mb-3 ml-1">Primary Contact</label>
                    <input type="text" placeholder="e.g. Jane Doe, Global Supply Chain" className="w-full h-14 bg-slate-50 border border-slate-200 rounded-xl px-5 text-sm font-bold text-slate-900 tracking-wide outline-none focus:border-primary focus:bg-white focus:ring-4 ring-primary/10 transition-all" />
                 </div>
                 <div>
                    <label className="block text-[10px] font-bold tracking-widest text-slate-500 uppercase mb-3 ml-1">Business Email</label>
                 ...
                 <div>
                    <label className="block text-[10px] font-bold tracking-widest text-slate-500 uppercase mb-3 ml-1">Monthly Shipping Volume</label>
           ...
           <div className="space-y-6 flex flex-col justify-start pt-4">
              <div className="bg-[#0B0E27] text-white p-10 rounded-2xl shadow-xl relative overflow-hidden group border border-indigo-900/50">
                 ...
                 <div className="flex items-center gap-4 mb-2 relative z-10">
                    ...
                    <h4 className="text-xs font-bold tracking-widest uppercase text-slate-300">US Operations Hub</h4>
                 </div>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-200/80 relative group hover:border-slate-300 transition-colors">
                 ...
                 <div className="flex items-center gap-4 mb-2 relative z-10">
                    ...
                    <h4 className="text-xs font-bold tracking-widest uppercase text-slate-500">India Operations Hub</h4>
                 </div>
