...
const routes = [
  ...
  },
  {
    ...
    icon: 'air',
    carrier: 'FedEx Int.',
    carrierColor: 'bg-orange-100 text-orange-700',
    carrierInitials: 'FX',
    level: 'PRIORITY',
  ...
  return (
    <div className="p-8 lg:p-10 min-h-full pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-10">
        <div>
          <h1 className="text-[34px] font-black text-[#1e4b7a] tracking-tight mb-3">Rates &amp; Routes</h1>
        ...
        <button className="h-11 px-6 rounded-xl bg-[#1e4b7a] text-white font-bold text-sm tracking-wide gap-2 flex items-center hover:bg-[#1e4b7a] shadow-md transition-colors flex-shrink-0 self-start">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm flex flex-col justify-between h-36">
          ...
          <div>
            <div className="flex items-end gap-3">
              <span className="text-[38px] font-black text-[#1e4b7a] tracking-tight leading-none">142</span>
        ...
        {/* Avg Rate */}
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-7 shadow-lg flex flex-col justify-between h-36 text-white">
          <p className="text-[11px] font-bold uppercase tracking-widest text-orange-100">AVG. Rate / KG</p>
          <div>
            <div className="flex items-end gap-3">
              <span className="text-[38px] font-black tracking-tight leading-none">Â£4.12</span>
              <span className="text-[13px] font-bold text-orange-100 mb-1">Global Aggregate</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm flex items-center justify-between h-36">
          <div>
            ...
            <h3 className="text-[18px] font-black text-[#1e4b7a] mb-1">Live Carrier Sync</h3>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-4 mb-8">
        <div className="relative w-full lg:w-80">
          ...
          <input
            ...
            className="w-full h-11 bg-white border border-slate-200 rounded-xl pl-11 pr-4 text-sm font-medium text-slate-700 outline-none focus:ring-2 ring-orange-500/20 placeholder:text-slate-400"
          />
        </div>
        ...
        <div className="flex items-center gap-3 ml-auto flex-wrap">
          ...
          <button className="h-9 px-4 rounded-lg bg-[#1e4b7a] text-white font-bold text-[12px] tracking-wide">UK (LHR)</button>
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden mb-8">
                ...
                <tr key={route.id} className="hover:bg-slate-50/60 transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-black text-[#1e4b7a] text-[14px] tracking-tight mb-0.5">
                          {route.code.split(' â†’ ')[0]} <ArrowRight className="w-3 h-3 inline mb-0.5 text-slate-400" /> {route.code.split(' â†’ ')[1]}
                        </p>
                  ...
                  {/* Base Rate */}
                  <td className="px-6 py-6">
                    <span className="font-black text-[#1e4b7a] text-[18px] tracking-tight">{route.rate}</span>
                  </td>
        ...
        <div className="flex items-center justify-between px-8 py-5 border-t border-slate-100 bg-white">
          ...
          <div className="flex items-center gap-2">
            ...
            {[1, 2, 3].map(p => (
              <button key={p} className={`w-9 h-9 rounded-xl flex items-center justify-center text-[13px] font-bold transition-colors ${p === 1 ? 'bg-[#1e4b7a] text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}>
                {p}
              </button>
            ))}
            <button className="w-9 h-9 rounded-xl bg-slate-100 hover:bg-slate-200 flex items-center justify-center transition-colors text-slate-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
        ...
        {/* Intelligence Alert */}
        <div className="bg-gradient-to-br from-[#1e4b7a] to-[#1e4b7a] rounded-3xl p-8 shadow-xl text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/15 rounded-full text-[9px] font-bold tracking-widest uppercase text-orange-200 mb-5 backdrop-blur-sm">
              Intelligence Alert
            </div>
            <h3 className="text-[22px] font-black text-white mb-4 tracking-tight">Fuel Surcharge Update</h3>
            <p className="text-[14px] text-orange-100/90 font-medium leading-relaxed mb-6 max-w-sm">
            ...
            <button className="flex items-center gap-2 text-[13px] font-bold text-white hover:text-orange-200 transition-colors underline underline-offset-4 decoration-orange-400/50">
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm flex flex-col justify-between">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="w-12 h-12 bg-orange-50 rounded-2xl flex items-center justify-center mb-5">
                <BarChart2 className="w-6 h-6 text-[#1e4b7a]" />
              </div>
              <h3 className="text-[20px] font-black text-[#1e4b7a] mb-3 tracking-tight">Carrier Performance</h3>
          ...
          <div className="mt-8">
            ...
            <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden">
              <div className="h-2 w-[98.4%] bg-gradient-to-r from-[#1e4b7a] to-orange-400 rounded-full"></div>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-slate-200/70 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div>
          <h2 className="font-bold text-[#1e4b7a] text-[16px] mb-1">ship2sell Logistics</h2>
          <p className="text-[12px] text-slate-500 font-medium">© 2024 ship2sell Logistics. All rights reserved.</p>
        </div>
        <div className="flex flex-wrap gap-6 text-[12px] font-bold text-slate-500">
          <a href="#" className="hover:text-[#1e4b7a] transition-colors hover:underline underline-offset-4">Privacy Policy</a>
          <a href="#" className="hover:text-[#1e4b7a] transition-colors hover:underline underline-offset-4">Terms of Service</a>
          <a href="#" className="hover:text-[#1e4b7a] transition-colors hover:underline underline-offset-4">Global Compliance</a>
          <a href="#" className="hover:text-[#1e4b7a] transition-colors hover:underline underline-offset-4">Sustainability</a>
          <a href="#" className="hover:text-[#1e4b7a] transition-colors hover:underline underline-offset-4">Carrier Relations</a>
        </div>
      </div>
